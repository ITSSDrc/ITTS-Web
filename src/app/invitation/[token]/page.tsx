...
export default function InvitationPage({ params }: InvitationPageProps) {
  ...
  // Unwrap params safely using useEffect to avoid hydration issues in Next.js 15
  useEffect(() => {
    params.then((p) => setToken(p.token)).catch((err) => setError("Erreur de lien"));
  }, [params]);
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-neutral-950 flex flex-col items-center justify-center p-4">
        ...
        <p className="text-neutral-400 font-medium">Préparation de votre carte...</p>
      </div>
    );
  }
  ...
  if (error || !invitation || !invitation.event || !invitation.guest) {
    return (
      <div className="min-h-screen bg-neutral-950 flex flex-col items-center justify-center p-4 text-center">
        ...
        <h1 className="text-2xl font-bold text-white mb-2">Invitation inaccessible</h1>
        ...
        <Card className="overflow-hidden border-none shadow-[0_32px_64px_-12px_rgba(0,0,0,0.8)] rounded-[2.5rem] bg-white text-neutral-900">
          <div className="relative h-64 w-full bg-neutral-200">
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white">
              ...
              <h1 className="text-3xl font-bold tracking-tight leading-tight uppercase font-headline">{event.title}</h1>
            </div>
          </div>
          ...
          <CardContent className="p-8 md:p-10">
            <div className="text-center mb-10">
              ...
              <h2 className="text-3xl font-extrabold text-neutral-900 tracking-tight">{guest.name}</h2>
            </div>
            ...
            <div className="space-y-6 mb-10">
              <div className="flex items-start gap-5">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-lg font-bold text-neutral-900">
                    {isDateValid ? format(eventDate, 'EEEE d MMMM yyyy', { locale: fr }) : 'Date à confirmer'}
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-5">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-lg font-bold text-neutral-900">
                    {isDateValid ? format(eventDate, 'HH:mm', { locale: fr }) : '--:--'}
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-5">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-lg font-bold text-neutral-900">{event.location || 'Lieu communiqué prochainement'}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center p-8 bg-neutral-900 rounded-[2rem] shadow-inner mb-10">
               ...
               <p className="text-[9px] text-neutral-500 mt-6 font-mono tracking-widest uppercase">ID: {token?.substring(0, 18)}...</p>
            </div>
