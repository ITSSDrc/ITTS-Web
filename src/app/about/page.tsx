...
export const teamMembers = [
  { id: "isaac-alfani-ceo", name: "Isaac Alfani", role: "CEO", imageId: "team-member-0", initials: "IA", bio: "Leader visionnaire avec plus de 20 ans d'expérience dans la conduite de la transformation numérique et de la croissance des entreprises. Isaac Alfani est passionné par l'exploitation de la technologie pour résoudre des défis complexes et créer un impact durable pour les clients et la société." },
